...
<div class="gt-layout">
  ...
  <aside class="gt-sidebar" id="sidebar">
    ...
    <a href="{{ route('institute.dashboard') }}" class="gt-nav-item">
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/></svg>
      Dashboard
    </a>

    <div class="gt-sidebar-section">Academics</div>
    <a href="{{ route('institute.courses.index') }}" class="gt-nav-item">
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/></svg>
      Courses
    </a>
    <a href="{{ route('institute.courses.enrollments') }}" class="gt-nav-item">
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>
      Subjects
    </a>

    <div class="gt-sidebar-section">Students</div>
    <a href="{{ route('institute.students.index') }}" class="gt-nav-item">
    ...
    <a href="{{ route('institute.attendance.student') }}" class="gt-nav-item">
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="9 11 12 14 22 4"/><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/></svg>
      Academic History
    </a>

    <div class="gt-sidebar-section">Fees</div>
    <a href="{{ route('institute.fee.index') }}" class="gt-nav-item">
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>
      Fee Collection
    </a>

    <div class="gt-sidebar-section">Team</div>
    <a href="{{ route('institute.staff.index') }}" class="gt-nav-item">
