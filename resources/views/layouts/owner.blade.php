...
<div class="gt-layout">
  ...
  <aside class="gt-sidebar" id="sidebar">
    ...
    <div class="gt-sidebar-section">System</div>
    <a href="{{ route('owner.settings.index') }}" class="gt-nav-item {{ request()->routeIs('owner.settings.*') ? 'active' : '' }}">
    ...
    <div class="gt-sidebar-footer">
      ...
      <form action="{{ route('owner.logout') }}" method="POST" style="margin-top:10px;">
        @csrf
