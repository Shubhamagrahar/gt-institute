...
class AttendanceStudent extends Model {
    ...
    protected $fillable = ['institute_id','user_id','batch_id','date','in_time','out_time','status','created_by'];
...
class AttendanceStaff extends Model {
    ...
    protected $fillable = ['institute_id','user_id','date','in_time','out_time','status','created_by'];
